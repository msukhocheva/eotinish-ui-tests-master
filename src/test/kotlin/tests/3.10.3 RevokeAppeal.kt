...
class ContinueAppealExecutionAfterRevoke (
    ...
    @Test
    fun continueAppealExecutionAfterRevokeTest() {
        testTimeout
        ...
        org1Executor1.page.click(appealCardPage.continueExecution_btn)

        org1Executor1.page.click(appealCardPage.reasonOfRevokeCancellation_input)
        org1Executor1.page.fill(appealCardPage.reasonOfRevokeCancellation_input, appealCardPage.reasonOfRevokeCancellation)
        org1Executor1.page.click(appealCardPage.yes_btn)
        ...
        if (assert) {
            ...
            println("Test 3.10.3  passed ($appealType ЖТ-2022-$appealNumber)")
        }
    }
}
