...
class ExecuteComplaintsWithHearing {
    ...
    fun executeComplaintsWithHearing() {
        ...
        for (i in regNumbersOfCreatedComplaints.indices) {
            ...
            //Нажимаем кнопку "Заслшиваание проведено"
        ...
        if (assert) {
            ...
            println("Test 3.4.1   passed (${typesOfCreatedComplaints[0]}, ЖТ-2022-${regNumbersOfCreatedComplaints[0]})")
