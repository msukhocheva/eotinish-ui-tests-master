...
class SendAssignmentToWork3(private var assert: Boolean = true) {
    ...
    fun sendAssignmentToWorkTest() {
        ...
        //Направляем поручение в работу Исполнителю из структурного подразделения в организации Org.3
        ...
        if (assert) {
            println("Test 4.2.3   passed ($assignmentNumber)")
        }
    }
}