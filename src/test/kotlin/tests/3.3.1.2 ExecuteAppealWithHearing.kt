...
class ExecuteAppealsGroupTwoWithHearing {
    ...
    @Test
    fun executeAppealsGroupTwoWithHearing() {
        ...
        for (i in regNumbersOfCreatedAppeals.indices) {
            ...
            //Проверяем корректно ли отображаются типы решений и типы причин
            if (assert) {
        ...
        if (assert) {
            ...
            println("Test 3.3.1.2 passed (${typesOfCreatedAppeals[0]}, ЖТ-2022-${regNumbersOfCreatedAppeals[0]})")
