...
class ReassignExecutor(private var assert: Boolean = true) {
    ...
    fun reassignExecutor() {
        ...
        //Проверяем залогинен ли Руководитель, если нет, то логинимся под ним и направляем в работу Исполнителю-1
       switchOnUser(org1Chief1)
        ...
        //Проверяем залогинен ли Руководитель, если нет, то логинимся под ним и направляем в работу Исполнителю-2
        switchOnUser(org1Chief1)
        ...
        //Проверяем залогинен ли Исполнитель-2, если нет, то логинимся под ним и проверяем есть ли обращение
        ...
        if (assert) {
            ...
            println("Test 3.2.5   passed ($appealTypeName ЖТ-2022-$appealNumber)")
        }
    }
}